...
type DocumentServiceInterface interface {
	CreateDocument(ctx context.Context, doc *apiModels.DocumentRequest) (*apiModels.DocumentResponse, error)
	GetAll(ctx context.Context) ([]apiModels.DocumentResponse, error)
}
...
func (s *DocumentService) GetAll(
	...
	var documentResponses []apiModels.DocumentResponse
	for _, doc := range documents {
		documentResponses = append(documentResponses, apiModels.DocumentResponse{
			ID:     doc.ID.String(),
			Author: doc.Author,
			Title:  doc.Title,
		})
