...
const isAtTopLevel = (node) => {
    ...
    return (!!((_a = node.parent) === null || _a === void 0 ? void 0 : _a.parent) &&
        node.parent.parent.type === utils_1.TSESTree.AST_NODE_TYPES.ExpressionStatement) ||
        (((_c = (_b = node.parent) === null || _b === void 0 ? void 0 : _b.parent) === null || _c === void 0 ? void 0 : _c.type) === utils_1.TSESTree.AST_NODE_TYPES.AwaitExpression &&
            !!node.parent.parent.parent &&
            node.parent.parent.parent.type ===
                utils_1.TSESTree.AST_NODE_TYPES.ExpressionStatement);
};
